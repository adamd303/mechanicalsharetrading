...
namespace Adam.Trading.Mechanical.Model
{
    ...
    public class LineData
    {
        ...
        private TradingEnumerations.TopBottom _topBottom = TradingEnumerations.TopBottom.Unknown;
        ...
        /// </summary>
        public TradingEnumerations.TopBottom TopBottom
        {
        ...
        /// <param name="date"></param>
        /// <param name="price"></param>
        public LineData(DateTime date, decimal price, int index, TradingEnumerations.TopBottom topBottom)
        {
            _date = date;
            _price = price;
            _index = index;
